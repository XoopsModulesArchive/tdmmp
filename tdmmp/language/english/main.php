...
define("_PM_YOUDONTHAVE","You don't have any private messages in the folder...");
define("_PM_YOUDONTHAVECONTACT","You don't have any contact...");
define("_PM_FROMC","From: ");
define("_PM_SENTC","Sent: "); // The date of message sent
define("_PM_PROFILE","Profile of");

//contact
define("_PM_COM","Posts");
define("_PM_JOINDATE","Member since");
define("_PM_CONTACTLAST","Last Online");
define("_PM_GROUPES","Groups");
//define("_PM_AVATAR","Avatar");
//define("_PM_PAR","Par: ");
//define("_PM_CONTACTDELETED","Votre (vos) contact(s) a (ont) &#233;t&#233; effac&#233;(s)");
define("_PM_ETAT","State");
...
define("_PM_SAVEDRAFT","Save Draft ?");
...
define("_PM_EMPTY","Empty box");
define("_PM_REPLY","Reply");
define("_PM_ADDCONTACT","Added to your contacts");
...
define("_PM_SAVED_ALL","Messages have been moved");
define("_PM_UNSAVED","Messages have been removed");
...
define("_PM_RUSURESAUV","Are you sure you want to move message(s)?");
...
define("_PM_ACTION_MSG","See my messages");
//version 1.2
define("_PM_BYC" "by : ");
define("_PM_STYLE","Style");
//define("_PM_MASQUEFOLDER","Show / Hide files");
//define("_PM_MASQUEBOX","Show / Hide the toolbox");

//1.3
define("_PM_QUOTE","Quote");

// 1.5
define("_PM_MASQUEFOLDER","Hide Folders");
define("_PM_MASQUEBOX","Hide the toolbox");
define("_PM_MASQUEVIEW","Hide the message");

//1.6
define("_PM_ALERT_POURC","You use %s, the storage space allocated to you");
define("_PM_ALERT_MSG","Your email uses up too much space, please sort your messages. <br />You can not use private messaging as this sort will not be made <br /> Thank you for your understanding");
